...
/**
 * ETH Zürich, Leitprogramm, Binäre Suchbäume ---- In dieser Klasse wird ein
 * Binärbaum erzeugt und die Methode preorderPrint() aufgerufen. Sie müssen an
 * dieser Klasse nichts verändern, rufen Sie einfach die main-Methode auf. So
 * können Sie Ihre Implementation testen.
 *
...
public class Aufgabe3_3 {
    ...
    /**
     * In dieser Methode wird ein Binärbaum erzeugt und Ihre Implementation von
     * preorderPrint() aufgerufen. Danach wird die korrekte Ausgabe angezeigt,
     * so dass Sie einfach überprüfen können, ob Sie die Methode richtig
     * implementiert haben.
     *
     * @param args unused
     */
